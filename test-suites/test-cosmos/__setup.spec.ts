...
const MOCK_USD_PRICE_IN_WEI = CosmosConfig.ProtocolGlobalParams.MockUsdPriceInWei;
const ALL_ASSETS_INITIAL_PRICES = CosmosConfig.Mocks.AllAssetsInitialPrices;
const USD_ADDRESS = CosmosConfig.ProtocolGlobalParams.UsdAddress;
const MOCK_CHAINLINK_AGGREGATORS_PRICES = CosmosConfig.Mocks.AllAssetsInitialPrices;
const LENDING_RATE_ORACLE_RATES_COMMON = CosmosConfig.LendingRateOracleRatesCommon;
...
const buildTestEnv = async (deployer: Signer, secondaryWallet: Signer) => {
  ...
  const addressesProvider = await deployLendingPoolAddressesProvider(CosmosConfig.MarketId);
