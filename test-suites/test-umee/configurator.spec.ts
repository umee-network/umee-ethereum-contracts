...
import { strategyWETH } from '../../markets/umee/reservesConfigs';
...
makeSuite('LendingPoolConfigurator', (testEnv: TestEnv) => {
  ...
  it('Check the onlyUmeeAdmin on deactivateReserve ', async () => {
  ...
  it('Check the onlyUmeeAdmin on activateReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyUmeeAdmin on freezeReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyUmeeAdmin on unfreezeReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyUmeeAdmin on disableBorrowingOnReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyUmeeAdmin on enableBorrowingOnReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyUmeeAdmin on configureReserveAsCollateral ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
      configurator
  ...
  it('Check the onlyUmeeAdmin on disableReserveStableRate', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyUmeeAdmin on enableReserveStableRate', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
