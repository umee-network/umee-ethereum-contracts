...
task(`deploy-${eContractid.UiPoolDataProvider}`, `Deploys the UiPoolDataProvider contract`)
  ...
  .setAction(async ({ verify }, localBRE) => {
    ...
    const addressesByNetwork: {
      [key: string]: { incentivesController: string; umeeOracle: string };
    } = {
      ...
      [ePolygonNetwork.matic]: {
        ...
        umeeOracle: '0x21451bD7b528896B4AB2b9764b521D6ed641708d',
      },
      [ePolygonNetwork.mumbai]: {
        incentivesController: '0xd41aE58e803Edf4304334acCE4DC4Ec34a63C644',
        umeeOracle: '0xC365C653f7229894F93994CD0b30947Ab69Ff1D5',
      },
    };
    ...
    const oracle = addressesByNetwork[network].umeeOracle;
    const incentivesController = addressesByNetwork[network].umeeOracle;
